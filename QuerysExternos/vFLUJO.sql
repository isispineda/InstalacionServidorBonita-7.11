...
SELECT        f.APELLIDOS_MOTORISTA, f.CODIGO_CASO, f.CONTENEDOR, f.CORREO_AVISO, f.ESTADO_FLUJO, f.FECHA_ADICION, f.FECHA_ENTRADA_LISTA, f.FECHA_FIN, f.FECHA_INICIO, f.FECHA_INICIO_SALIDA, f.FECHA_MODIFICACION, 
                         f.FECHA_NAC_MOTORISTA, f.FECHA_SALIDA_LISTA, f.FECHA_VENC_DOC_MOTORISTA, f.ID_ORIGEN_LECTURA, f.INICIO_SALIDA, f.MARCHAMO, f.NO_DOC_MOTORISTA, f.NOMBRES_MOTORISTA, f.OBSERVACION_FLUJO, 
                         f.PARABRISAS, f.PARQUEO, f.persistenceVersion, f.PESO, f.PLACA, f.SALIDA_LISTA, f.T_MAXIMO, f.T_MINIMO, f.TELEFONO_AVISO, f.TIPO_FINALIZACION, f.TIPO_FLUJO, f.TRASERA, f.USUARIO_ADICION, 
                         f.USUARIO_MODIFICACION, f.VACIO, f.ID_FRONTERA_PID, f.ID_PC_INGRESO_PID, f.ID_PC_SALIDA_PID, f.ID_PROCESO_PID, f.ID_TIPO_MT_PID, f.PAIS_DOCUMENTO_PID, f.PLACA_PAIS_PID, f.TRASERA_PAIS_PID, 
